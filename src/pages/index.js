        ...
        <div class='row'>
                ...
                <div class='blue-column'>
                    ...
                    <div class='row'>
                        <div id='featureLeftCol'>
                            <div class='red-column' style={{marginLeft:30}}>
            ...
            <div class='columnRight'>
                <div class='searchForm'>
                    <div>
                        <form style={{background: '#3b4252', padding:110,paddingBottom:114, marginLeft:15}}>
                            ...
                            <br />
                            <button style={{width: 250, height:50}}>Search</button>
                        </form>
                    </div>
                </div>
            </div>
